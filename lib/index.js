...
// return Promise
Crowdin.prototype.postRequest = function(uri, params) {
    return this.requestData({
        uri: this.config.endpointUrl + '/' + uri,
        method: 'POST',
        form: params,
...
// return Stream
Crowdin.prototype.upload = function(files, language, import_duplicates, import_eq_suggestions, auto_approve_imported, json, jsonp) {
    return this.postRequest('upload-translation', {
        files: files,
        language: language,
        import_duplicates: import_duplicates || 0,
        import_eq_suggestions: import_eq_suggestions || 0,
        auto_approve_imported: auto_approve_imported || 0,
        json: json || null,
        jsonp: jsonp || null
    });
};
